...
- Press <kbd>CTRL + W</kbd> and <kbd>ENTER</kbd>: `;opcache.interned_strings_buffer=8`.
  - Replace this line with `opcache.interned_strings_buffer`. This is a requiremnet for nextcloud <br>

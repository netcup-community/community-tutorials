...
* server_name
  * Instead of the underscore `_`, you can enter your domain here on which your Rails app should run. With underscore `_`, every domain that is routed to the server is served with the Rails app.
* root
...
If it says something like `Rails 7.0.2`, you are ready to continue.

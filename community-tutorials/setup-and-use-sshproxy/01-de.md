...
Zum Zeitpunkt der Erstellung des Tutorials ist der VPS 200 G8 das empfohlene 
Produkt für die Nutzung als SSH-Proxy. Zur Verwendung einfach den VPS 200 
neuester Generation aus der Auswahl von [VPS](https://www.netcup.de/vserver/vps.php) verwenden.
...
3. Es ist empfehlenswert, an dieser Stelle einen SSH-Schlüssel einzurichten und
   ...
   im Tutorial [use-ssh-key-login](https://github.com/netcup-community/community-tutorials/blob/main/community-tutorials/use-ssh-key-login/01-en.md). Die spätere Funktionalität benötigt
   root-Fähigkeiten, deshalb wird an dieser Stelle auf die Einrichtung eines
   unprivilegierten Benutzers verzichtet.
...
Deutschland befindet, falls die Geolokalisierung der eigenen IP nicht korrekt

...
Now we set in apache2 that every request is redirected from http to https and we delete the apache2 default configs because we do not need them:
```sh
...
```
Save your edit with <kbd>ctrl + x</kbd>, then press <kbd>y</kbd> and now save it with enter and restart apache
```sh
...
Save your edit with <kbd>ctrl + x</kbd>, then press <kbd>y</kbd> and now save it with enter <br/>
...
```
Save your edit with <kbd>ctrl + x</kbd>, then press <kbd>y</kbd> and now save it with enter <br/>
Now Open the configuration of the domain/subdomain in which you want to use PHPMyAdmin (Change FILE.conf with the name of the configuration file of your domain/subdomain)
```sh
...
So it should look like this - the green line must be added (but without the + before the line):
```diff
<VirtualHost *:443>
    ServerName DOMAIN
...
```
Now save your edit with <kbd>ctrl + x</kbd>, then press <kbd>y</kbd> and now save it with enter <br/>
...
Now save your file with <kbd>ctrl + x</kbd>, then press <kbd>y</kbd> and now save it with enter <br/>

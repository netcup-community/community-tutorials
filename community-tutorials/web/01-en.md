...
```
Save your edit with <kbd>CTRL + X</kbd>, then press <kbd>y</kbd> and now save it with <kbd>ENTER</kbd> <br/>
Open the configuration of the domain/subdomain in which you want to use PHPMyAdmin (Change FILE.conf with the name of the configuration file of your domain/subdomain)
```sh
...
Open Wordpress over https://DOMAIN/ and follow the shown steps

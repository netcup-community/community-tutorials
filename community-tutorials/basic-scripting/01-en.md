...
```
# Conclusion
In this tutorial, we learnt how we can write basic POSIX compatible scripts including commands, comments, variables, If statements, math and delays. 
# License
MIT

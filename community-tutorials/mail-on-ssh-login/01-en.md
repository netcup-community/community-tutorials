...
description: How to set up your server to send an email to you when someone logs into your server.
We will use SMTP to send mails via our existing email account.  
level: [beginner] 

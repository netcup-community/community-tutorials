...
```sh
openssl req -x509 -newkey rsa:8192 -keyout /etc/ssl/privkey.pem -out /etc/ssl/fullchain.pem -sha256 -days 365000
```
- Enter something (like 2314432)
- Enter the same again
- Now you can fill the next asked values or skip them with pressing enter

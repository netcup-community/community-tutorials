...
```sh
apt install apache2 libapache2-mod-php libapache2-mod-fcgid -y
service apache2 stop
a2enmod rewrite headers env dir mime proxy proxy_http proxy_wstunnel headers ssl http2 expires filter
cd /etc/apache2/
nano apache2.conf
```

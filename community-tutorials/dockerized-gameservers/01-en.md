...
In that case please follow the docker installation tutorial again. (See https://docs.docker.com/engine/install/ for the official documentation.)
...
If you want to play on workshop maps (see: https://steamcommunity.com/workshop/browse/?appid=730) you also need to get the API key for your steam account here: https://steamcommunity.com/dev/apikey. 

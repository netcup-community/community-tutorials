---
title: Setup of a Minecraft-server with plugins
description: Learn how to set up a Minecraft-server with auto-update and auto-start.
...
3. Create a user (`adduser`) and give him root-rights (`usermod -aG sudo <USER>`)

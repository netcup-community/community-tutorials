...
# Introduction
This tutorial will show you, how you can install the Pufferpanel on a Debian or Ubuntu Server on the server "RS 2000" through apt and how you can set up a apache2 reverse proxy to it <br>
...
Do not forget to open the correct port of the server, which you created in the pufferpanel, if it requires also an open port (for example, a Minecraft server/proxy requires port 25565)

...
If you want to use https and a domain or subdomain, you need also to have the server open to the internet on port 80 and 443 <br>
And Java 17 installed if you want to use the pufferpanel for minecraft servers (see step 0)

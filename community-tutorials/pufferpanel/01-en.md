...
First create a subdomain, which is located to your server and name it pp.example.com (replace example.com with your domain) <br>
Now create an SSL Certificate (Replace example.com with your domain):
```sh
...
```
Now edit this configuration and replace every `example.com` with your domain <br>
Save your edit with ctrl + x, then press y and now save it with enter <br>
Now restart apache
```sh
service apache2 restart

...
Save your changes by first pressing <kbd>CTRL + X</kbd>, then press <kbd>y</kbd> and finally hit <kbd>ENTER</kbd>.
...
# Step 4 - Make it possible to run a pufferpanel-server inside of a docker container - optional
First we need to install docker it self
```sh
